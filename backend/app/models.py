...
Postgres is the shared-store path; SQLite stays the local fallback. Reaction
counts are derived with COUNT rather than kept in denormalised columns: at feed
scale it is free, and a counter that cannot drift is one less thing to debug on
demo day.
